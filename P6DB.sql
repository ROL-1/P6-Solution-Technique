...
CREATE TABLE IF NOT EXISTS `P6DB`.`User` (
  ...
  `Opinion_opinion_id` INT NULL,
  `Adress_adress_id` INT NOT NULL,
  PRIMARY KEY (`user_id`),
  INDEX `fk_User_Opinion1_idx` (`Opinion_opinion_id` ASC) VISIBLE,
  INDEX `fk_User_Adress1_idx` (`Adress_adress_id` ASC) VISIBLE,
  UNIQUE INDEX `user_id_UNIQUE` (`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_User_Opinion1`
    FOREIGN KEY (`Opinion_opinion_id`)
    REFERENCES `P6DB`.`Opinion` (`opinion_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
